...
-- be part of the duplicate key. Otherwise the same transaction imported once as
-- source='shell_excel' and once as source='shell' remains duplicated on screen.
--
-- Natural Shell transaction identity:
-- plate + second-level datetime + liters + amount + raw fuel + station.
...
-- it arrives as a different Shell source variant.
